...
enum RouterVersion {
  EFINV2Router01 = 'EFINV2Router01',
  EFINV2Router02 = 'EFINV2Router02'
}

describe('EFINV2Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.EFINV2Router01]: fixture.router01,
        [RouterVersion.EFINV2Router02]: fixture.router02
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.EFINV2Router01]: 102328,
              [RouterVersion.EFINV2Router02]: 102350
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
