...
const BSCSCAN_API_KEY = 'BSCSCAN_API_KEY';
...
EnvConfig.prototype.initializeConf = function() {
    ...
    this.createItem(BSCSCAN_API_KEY, undefined, 'BSCscan API key to use to validate the contracts.');
}
...
EnvConfig.prototype.getBscscanApiKey = function() {
    return this.conf.get(BSCSCAN_API_KEY);
}
